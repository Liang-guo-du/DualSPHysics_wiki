...
A more complete description of the code and the XML files can be found in **XML_v4.2_GUIDE.pdf** available in **DualSPHysics_v4.2/doc/pdf**. This document helps to create a new case using the input XML file and all XML parameters are explained and related to SPH equations.

An example of input XML is shown here; the CaseWavemaker_Def.xml included in **DualSPHysics_v4.2/examples/main/06_Wavemaker**:
