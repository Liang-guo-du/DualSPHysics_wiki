...
The viscosity is varied to simulate different Reynolds numbers, particularly a steady case (Re = 20, Figure 12-X8 below) and an unsteady case (Re = 100, Figure 12-X9 below).
...
The solution can be validated against the analytical solution provided in [Tafuni et al. 2018](https://doi.org/10.1016/j.cma.2018.08.004). An Excel file named <strong>Analytical_solution_slope_channel.xslx</strong> is present in the test case folder with a list of the simulation parameters and the resulting velocity profile along Z. In particular, for the case Re = 100, the analytical profile is given below in Figure 12-X11.

<p align="center">
<img src="https://i.imgur.com/ftAtzGP.png" />
</p>

<p align="center">
<strong>Figure 12-X11.</strong> Analytical velocity profile along the z-direction for open-channel flow at Re = 100.
</p>
