...
Water surface elevation is measured using **MeasureTool**. Detailed comparisons of water surface elevation and velocities with experimental results can be found in Altomare et al. (2015b). This validation can be also seen at (https://www.youtube.com/watch?v=OzPjy2aMuKo) 


## 12.6 INLETOUTLET EXAMPLES
