...
<p align="center">
<img src="https://i.imgur.com/9X9PtdL.png" />
</p>

<p align="center">
<strong>Figure 12-51.</strong> XXXXXXXXXXXXXX.
</p>
...
<p align="center">
<strong>Figure 12-52.</strong> XXXXXXXXXXXXXX.
</p>

<p align="center">
<img src="https://i.imgur.com/P4JsLMg.png" />
</p>

<p align="center">
<strong>Figure 12-53.</strong> XXXXXXXXXXXXXX.
</p>
...
<p align="center">
<strong>Figure 12-54.</strong> XXXXXXXXXXXXXX.
</p>
...
<p align="center">
<img src="https://i.imgur.com/zs7acVz.png" />
</p>

<p align="center">
<strong>Figure 12-56.</strong> Test case for Chrono - pendulum.
</p>
...
<p align="center">
<img src="https://i.imgur.com/EuyldyR.png" />
</p>

<p align="center">
<strong>Figure 12-57.</strong> Test case for Chrono - demolisher.
</p>
...
<p align="center">
<img src="https://i.imgur.com/Ytoe5kq.png" />
</p>

<p align="center">
<strong>Figure 12-58.</strong> Test case for Chrono - spring.
</p>


Flexible Gate

* The Chrono implementation allows for the combination and multiple linking of bodies with restrictions. In this case, a flexible gate is emulated by linking rigid blocks with a series of hinges, with rotational rigidity and damped behavior.

<p align="center">
<img src="https://i.imgur.com/TR4XYvk.png" />
</p>

<p align="center">
<strong>Figure 12-59.</strong> Test case for Chrono - flexible case.
</p>
...
<p align="center">
<img src="https://i.imgur.com/dmx1Qbg.png" />
</p>

<p align="center">
<strong>Figure 12-60.</strong> Test case for Chrono - Pelamis case.
</p>
...
<p align="center">
<img src="https://i.imgur.com/2xfn1VT.png" />
</p>

<p align="center">
<strong>Figure 12-61.</strong> Test case for Chrono - OWSC case.
</p>
...
<p align="center">
<img src="https://i.imgur.com/TxOJt0E.png" />
</p>

<p align="center">
<strong>Figure 12-62.</strong> Test case for Chrono - Zipline case.
</p>
...
<p align="center">
<img src="https://i.imgur.com/GOI0H84.png" />
</p>

<p align="center">
<strong>Figure 12-63.</strong> Test case for Chrono - DamBreakCubes case.
</p>
...
<p align="center">
<img src="https://i.imgur.com/1ngPAND.png" />
</p>

<p align="center">
<strong>Figure 12-64.</strong> Test case for Chrono - WaterMill case.
</p>

Turbine

* A closed circuit driven by gravity provides the necessary momentum to a hinged body to rotate, given it's shape.

<p align="center">
<img src="https://i.imgur.com/p1UqFUr.png" />
</p>

<p align="center">
<strong>Figure 12-65.</strong> Test case for Chrono - Turbine case.
</p>
...
<p align="center">
<strong>Figure 12-66.</strong> Snapshot of CaseML_CIEM simulation. Colour represents the horizontal velocity of the fluid.
</p>

An instant the CaseML_CIEM simulation is shown in Figure **12-66** where the PartFluid_0345.vtk of the fluid particles and the PartMov_0345.vtk (in red) of the multi-layered piston wavemaker are depicted. The boundary, including the beach, is depicted in white color. 
...
<p align="center">
<strong>Figure 12-67.</strong> Snapshot of CaseRZ_RegularWaves  simulation. Colour represents the horizontal velocity of the fluid.
</p>

An instant the 02_RZ_RegularWaves  simulation is shown in Figure **12-67** where the PartFluid_0229.vtk of the fluid particles are depicted. The solid red line indicates edges of the relaxation zone inside which the theoretical velocity is imposed. Only horizontal velocities are applied, see line **coefdir x="1" y="0" z="0" comment="Coefficients for each direction (default=(1,0,0))"**.
...
<p align="center">
<strong>Figure 12-68.</strong> Snapshot of CaseRZ_IrregularWaves simulation. Colour represents the horizontal velocity of the fluid.
</p>

An instant the 03_RZ_IrregularWaves simulation is shown in Figure **12-68** where the PartFluid_0155.vtk of the fluid particles are depicted. The solid red line indicates edges of the relaxation zone inside which the theoretical velocity is imposed. Only horizontal velocities are applied, see line **coefdir x="1" y="0" z="0" comment="Coefficients for each direction (default=(1,0,0))"**. Looking figures **12-67** and **12-68**, the user can notice the differences in the water surface profile, regular monochromatic in **12-67** , meanwhile in figure **12-68** is characterized by individual waves of different amplitude and period.
...
<p align="center">
<strong>Figure 12-69.</strong> Snapshot of CaseRZ_Flow2D simulation. Colour represents the horizontal velocity of the fluid.
</p>
...
A snapshot of the 3-D simulation is depicted in Figure **12-70** . Karman vortexes are visible on the free surface. The yellow line before the cylinder defines the area where the relaxation zone is defined.
...
<p align="center">
<strong>Figure 12-70.</strong> Snapshot of CaseRZ_FlowCylinder3D simulation.
</p>
...
<p align="center">
<strong>Figure 12-71.</strong> Snapshot of CaseRZ_Coupling  simulation. Colour represents the horizontal velocity of the fluid.
</p>

An instant the 06_RZ_Coupling  simulation is shown in Figure **12-71** where the PartFluid_0635.vtk of the fluid particles are depicted. The solid red line indicates edges of the relaxation zone inside which the theoretical velocity is imposed. 
...
The viscosity is varied to simulate different Reynolds numbers, particularly a steady case (Re = 20, Figure 12-72 below) and an unsteady case (Re = 200, Figure 12-73 below).
...
<p align="center">
<strong>Figure 12-72.</strong> Contours of velocity magnitude (top) and vorticity in Y (bottom) for Re = 20.
</p>
...
<p align="center">
<strong>Figure 12-73.</strong> Contours of velocity magnitude (top) and vorticity in Y (bottom) for Re = 200.
</p>
...
<p align="center">
<strong>Figure 12-74.</strong> Time history of the vorticity in the wake at a horizontal distance of 5 diameters from the cylinder's center and a vertical coordinate equal to z=0).
</p>
...
<p align="center">
<strong>Figure 12-76.</strong> Comparison between SPH and analytical velocity profiles (horizontal axis in figure) along the z-direction (vertical axis in figure) for open-channel flow at Re = 100.
</p>
...
<p align="center">
<strong>Figure 12-77.</strong> Screenshot of velocity magnitude for the case of reverse flow with floating body.
</p>
...
<p align="center">
<strong>Figure 12-78.</strong> Wave generation using imposed velocity from linear wave theory at the inlet.
</p>
...
<p align="center">
<strong>Figure 12-79.</strong> Different types of buffer shapes created via the new inlet/outlet algorithm.
</p>
...
<p align="center">
<strong>Figure 12-80.</strong> Multi-inlet multi-outlet demonstration via 3-D box filled with water using four inlet areas.
</p>
...
<p align="center">
<strong>Figure 12-81.</strong> Simulation of flow past a boat hull using inlet/outlet buffer in three dimensions.
</p>
