...
<p align="center">
<strong>Figure 12-54.</strong> Instant of CaseTripleSolitaryWave simulation.
</p>
...
**FtConstraints**
Several XML files are included in this folder to show how to restrain some of the different degrees of freedom (DOF). 
We can restrain `<translation>` in x-axis (surge), in y-axis (sway) or in z-axis (heave)
and we can restrain `<translation>` along x-axis (roll), along y-axis (pitch) or along z-axis (yaw)
...
<p align="center">
<strong>Figure 12-63.</strong> Test case for Chrono - flexible case.
</p>
...
<p align="center">
<strong>Figure 12-64.</strong> Test case for Chrono - Pelamis case.
</p>
...
<p align="center">
<strong>Figure 12-65.</strong> Test case for Chrono - OWSC case.
</p>
...
<p align="center">
<strong>Figure 12-66.</strong> Test case for Chrono - Zipline case.
</p>
...
<p align="center">
<strong>Figure 12-67.</strong> Test case for Chrono - DamBreakCubes case.
</p>
...
<p align="center">
<strong>Figure 12-68.</strong> Test case for Chrono - WaterMill case.
</p>
...
<p align="center">
<strong>Figure 12-69.</strong> Test case for Chrono - Turbine case.
</p>
...
<p align="center">
<strong>Figure 12-70.</strong> Snapshot of CaseML_CIEM simulation. Colour represents the horizontal velocity of the fluid.
</p>

An instant the CaseML_CIEM simulation is shown in Figure **12-70** where the PartFluid_0345.vtk of the fluid particles and the PartMov_0345.vtk (in red) of the multi-layered piston wavemaker are depicted. The boundary, including the beach, is depicted in white color. 
...
<p align="center">
<strong>Figure 12-71.</strong> Snapshot of CaseRZ_RegularWaves  simulation. Colour represents the horizontal velocity of the fluid.
</p>
...
<p align="center">
<strong>Figure 12-72.</strong> Snapshot of CaseRZ_IrregularWaves simulation. Colour represents the horizontal velocity of the fluid.
</p>

An instant the 03_RZ_IrregularWaves simulation is shown in Figure **12-68** where the PartFluid_0155.vtk of the fluid particles are depicted. The solid red line indicates edges of the relaxation zone inside which the theoretical velocity is imposed. Only horizontal velocities are applied, see line **coefdir x="1" y="0" z="0" comment="Coefficients for each direction (default=(1,0,0))"**. Looking figures **12-71** and **12-72**, the user can notice the differences in the water surface profile, regular monochromatic in **12-71** , meanwhile in figure **12-72** is characterized by individual waves of different amplitude and period.
...
<p align="center">
<strong>Figure 12-73.</strong> Snapshot of CaseRZ_Flow2D simulation. Colour represents the horizontal velocity of the fluid.
</p>
...
A snapshot of the 3-D simulation is depicted in Figure **12-74** . Karman vortexes are visible on the free surface. The yellow line before the cylinder defines the area where the relaxation zone is defined.
...
<p align="center">
<strong>Figure 12-74.</strong> Snapshot of CaseRZ_FlowCylinder3D simulation.
</p>
...
<p align="center">
<strong>Figure 12-75.</strong> Snapshot of CaseRZ_Coupling  simulation. Colour represents the horizontal velocity of the fluid.
</p>

An instant the 06_RZ_Coupling  simulation is shown in Figure **12-75** where the PartFluid_0635.vtk of the fluid particles are depicted. The solid red line indicates edges of the relaxation zone inside which the theoretical velocity is imposed. 
...
The viscosity is varied to simulate different Reynolds numbers, particularly a steady case (Re = 20, Figure 12-76 below) and an unsteady case (Re = 200, Figure 12-77 below).
...
<p align="center">
<strong>Figure 12-76.</strong> Contours of velocity magnitude (top) and vorticity in Y (bottom) for Re = 20.
</p>
...
<p align="center">
<strong>Figure 12-77.</strong> Contours of velocity magnitude (top) and vorticity in Y (bottom) for Re = 200.
</p>
...
<p align="center">
<strong>Figure 12-78.</strong> Time history of the vorticity in the wake at a horizontal distance of 5 diameters from the cylinder's center and a vertical coordinate equal to z=0).
</p>
...
<p align="center">
<strong>Figure 12-79.</strong> Contours of velocity magnitude (top) and pressure (bottom) for open-channel flow at Re = 100.
</p>
...
<p align="center">
<strong>Figure 12-80.</strong> Comparison between SPH and analytical velocity profiles (horizontal axis in figure) along the z-direction (vertical axis in figure) for open-channel flow at Re = 100.
</p>
...
<p align="center">
<strong>Figure 12-81.</strong> Screenshot of velocity magnitude for the case of reverse flow with floating body.
</p>
...
<p align="center">
<strong>Figure 12-82.</strong> Wave generation using imposed velocity from linear wave theory at the inlet.
</p>
...
<p align="center">
<strong>Figure 12-83.</strong> Different types of buffer shapes created via the new inlet/outlet algorithm.
</p>
...
<p align="center">
<strong>Figure 12-84.</strong> Multi-inlet multi-outlet demonstration via 3-D box filled with water using four inlet areas.
</p>
...
<p align="center">
<strong>Figure 12-85.</strong> Simulation of flow past a boat hull using inlet/outlet buffer in three dimensions.
</p>
