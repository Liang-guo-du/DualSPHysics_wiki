...
The first test case shows the effectiveness of the proposed algorithm in simulating 2-D flow past a circular cylinder at different Reynolds numbers. A cylinder of diameter D = 0.2 m is discretized by dynamic boundary particles and surrounded by water. The fluid is initialized with a constant x-velocity, U = 1 m/s and a null y-velocity. The Reynolds number is defined as Re = U D/<i>nu</i>, where <i>nu</i> the kinematic viscosity in m<sup>2</sup>/s. 
