...
The viscosity is varied to simulate different Reynolds numbers, particularly a steady case (Re = 20, Figure 12-X7 below) and an unsteady case (Re = 200, Figure 12-X8 below).
...
<p align="center">
<strong>Figure 12-X7.</strong> Contours of velocity magnitude (top) and vorticity in Y (bottom) for Re = 20.
</p>
...
<p align="center">
<strong>Figure 12-X8.</strong> Contours of velocity magnitude (top) and vorticity in Y (bottom) for Re = 200.
</p>
...
<p align="center">
<strong>Figure 12-X9.</strong> Time history of the vorticity in the wake at a horizontal distance of 5 diameters from the cylinder's center and a vertical coordinate equal to z=0).
</p>
...
<p align="center">
<strong>Figure 12-X11.</strong> Comparison between SPH and analytical velocity profiles (horizontal axis in figure) along the z-direction (vertical axis in figure) for open-channel flow at Re = 100.
</p>
...
<p align="center">
<strong>Figure 12-X12.</strong> Screenshot of velocity magnitude for the case of reverse flow with floating body.
</p>
...
<p align="center">
<strong>Figure 12-X13.</strong> Wave generation using imposed velocity from linear wave theory at the inlet.
</p>
...
<p align="center">
<strong>Figure 12-X14.</strong> Different types of buffer shapes created via the new inlet/outlet algorithm.
</p>
...
<p align="center">
<strong>Figure 12-X15.</strong> Multi-inlet multi-outlet demonstration via 3-D box filled with water using four inlet areas.
</p>
...
<p align="center">
<strong>Figure 12-X16.</strong> Simulation of flow past a boat hull using inlet/outlet buffer in three dimensions.
</p>
