...
This folder includes several XML examples of how to use _link_pointline_ where a point of a body is connected to this line where different motions and rotations can be defined.
