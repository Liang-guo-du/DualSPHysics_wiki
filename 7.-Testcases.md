- [7.1 main examples](#71-main-examples)
...
- [7.8 multiphase examples](#78-multiphase-examples)
...
Different instants of the CaseWavemaker2D simulation are shown in Figure 7-20 where the _PartFluid_xxxx.vtk_ of the fluid particles and the _PartMoving_xxxx.vtk_ of the piston are depicted.
...
In Figure 7-45, the fixed _Pumpfixed.vtk_, the different _MotionPump.vtk_ and the _PartFluid_xxxx.vtk_ files of the fluid particles are represented at different instants of the simulation. 
...
In the case of spheres and cylinders (CaseFrSphere.xml and CaseFrCylinder.xml) the particles are initially created in a radial grid but maintaining the same initial particle distance.  
...
<p align="center">
<strong>Figure 7-XXX.</strong> Example of a sphere and a cylinder created using the new Free Draw Mode.
</p>

The example CaseFrBeach allows to create particles in a beach following the straight line of the slope, instead of the "stairs" effect that we obtain using the normal mode.
...
<p align="center">
<strong>Figure 7-XXX.</strong> Example of a slope created using the new Free Draw Mode.
</p>
...
These three examples are shown in Figure 7-55. Note that squares are used here to represent the individual nodes (particles will be created in those nodes) for clarity.
...
<p align="center">
<strong>Figure 7-55.</strong> Example A, B and C of the use of <redraw> and <redrawnear> commands.
</p>
...
One of the examples included in this folder is _RedrawSimple.xml_ where `<redraw>` is employed to close the holes in the boundary before filling with fluid (see Figure 7-56). The cases _RedrawComplex.xml_ y _RedrawComplexPeriodic.xml_ are more complex cases where the all options of `<redraw>` and `<redrawnear>` are used. 
...
<p align="center">
<strong>Figure 7-56.</strong> Different steps of the tasks in the example RedrawSimple.xml.
</p>
...
i) one box is created based on the 3-D Cartesian lattice used by GenCase, so that, the particles will be created in the nodes of that lattice (red box in Figure 7-57)

ii) the second box, is initially created using `<drawbox>` and later uses `<rotateaxis>` (in `<initials>` section) to apply a matrix that rotates the position of the particles of the box, so that, particles are finally created in global positions that are not linked to the nodes of the 3-D lattice (green box in Figure 7-57).
...
<p align="center">
<strong>Figure 7-57.</strong> Geometry generated using RotatedBox.xml.
</p>
...
<p align="center">
<strong>Figure 7-73.</strong> Snapshot of CaseML_CIEM simulation. Colour represents the horizontal velocity of the fluid.
</p>

An instant the CaseML_CIEM simulation is shown in Figure **7-73** where the PartFluid_0345.vtk of the fluid particles and the PartMov_0345.vtk (in red) of the multi-layered piston wavemaker are depicted. The boundary, including the beach, is depicted in white color. 
...
<p align="center">
<strong>Figure 7-74.</strong> Snapshot of CaseRZ_RegularWaves  simulation. Colour represents the horizontal velocity of the fluid.
</p>
...
<p align="center">
<strong>Figure 7-75.</strong> Snapshot of CaseRZ_IrregularWaves simulation. Colour represents the horizontal velocity of the fluid.
</p>

An instant the 03_RZ_IrregularWaves simulation is shown in Figure **7-75** where the PartFluid_0155.vtk of the fluid particles are depicted. The solid red line indicates edges of the relaxation zone inside which the theoretical velocity is imposed. Only horizontal velocities are applied, see line **coefdir x="1" y="0" z="0" comment="Coefficients for each direction (default=(1,0,0))"**. Looking figures **7-74** and **7-75**, the user can notice the differences in the water surface profile, regular monochromatic in **7-74** , meanwhile in figure **7-75** is characterized by individual waves of different amplitude and period.
...
<p align="center">
<strong>Figure 7-76.</strong> Snapshot of CaseRZ_Flow2D simulation. Colour represents the horizontal velocity of the fluid.
</p>
...
A snapshot of the 3-D simulation is depicted in Figure **7-77** . Karman vortexes are visible on the free surface. The yellow line before the cylinder defines the area where the relaxation zone is defined.
...
<p align="center">
<strong>Figure 7-77.</strong> Snapshot of CaseRZ_FlowCylinder3D simulation.
</p>
...
<p align="center">
<strong>Figure 7-78.</strong> Snapshot of CaseRZ_Coupling  simulation. Colour represents the horizontal velocity of the fluid.
</p>

An instant the 06_RZ_Coupling  simulation is shown in Figure **7-78** where the PartFluid_0635.vtk of the fluid particles are depicted. The solid red line indicates edges of the relaxation zone inside which the theoretical velocity is imposed. 
...
<p align="center">
<strong>Figure 7-79.</strong> Contours of velocity magnitude (top) and vorticity in Y (bottom) for Re = 20.
</p>
...
<p align="center">
<strong>Figure 7-80.</strong> Contours of velocity magnitude (top) and vorticity in Y (bottom) for Re = 200.
</p>
...
<p align="center">
<strong>Figure 7-81.</strong> Time history of the vorticity in the wake at a horizontal distance of 5 diameters from the cylinder's center and a vertical coordinate equal to z=0).
</p>
...
<p align="center">
<strong>Figure 7-82.</strong> Contours of velocity magnitude (top) and pressure (bottom) for open-channel flow at Re = 100.
</p>
...
<p align="center">
<strong>Figure 7-83.</strong> Comparison between SPH and analytical velocity profiles (horizontal axis in figure) along the z-direction (vertical axis in figure) for open-channel flow at Re = 100.
</p>
...
<p align="center">
<strong>Figure 7-84.</strong> Screenshot of velocity magnitude for the case of reverse flow with floating body.
</p>
...
<p align="center">
<strong>Figure 7-85.</strong> Wave generation using imposed velocity from linear wave theory at the inlet.
</p>
...
<p align="center">
<strong>Figure 7-86.</strong> Different types of buffer shapes created via the new inlet/outlet algorithm.
</p>
...
<p align="center">
<img src="https://i.imgur.com/AIZu395.png" />  
</p>

<p align="center">
<strong>Figure 7-87.</strong> Inlet buffer of cylindrical shape but with a different angle.
</p>
...
<p align="center">
<strong>Figure 7-88.</strong> Multi-inlet multi-outlet demonstration via 3-D box filled with water using four inlet areas.
</p>
...
<p align="center">
<strong>Figure 7-89.</strong> Simulation of flow past a boat hull using inlet/outlet buffer in three dimensions.
</p>

<a name="obc8"></a>
**7.6.8 8_ImpingingJet**
The last test case presented for inlet/outlet conditions is the 3-D vertical jet impinging on a flat bottom. A jet with a diameter of 0.03 m and at a heigth of 0.12 m is injected using an inlet velocity of 20 m/s. The impact with the flat bottom is shown in Figure 7-90.

<p align="center">
<img src="https://i.imgur.com/IApcP6S.png" /> 
</p>

<p align="center">
<strong>Figure 7-90.</strong> Simulation of jet impinging a flat bottom.
</p>
...
<p align="center">
<strong>Figure 7-XX.</strong> Snapshot of simulation of the examples in 01_StillWedge.
</p>
...
<p align="center">
<strong>Figure 7-XX.</strong> Particle pressure values vs depth at last instant of the CaseStillWedge simulation [English et al., 2019].
</p>
...
<p align="center">
<strong>Figure 7-XX.</strong> Snapshot of simulation of the examples in 02_Poiseuille.
</p>
...
<p align="center">
<strong>Figure 7-XX.</strong> Comparison between analytical and numerical Poiseuille flow velocities with DBC (left) and mDBC (right) [English et al., 2019].
</p>
...
<p align="center">
<strong>Figure 7-XX.</strong> Snapshot of simulation of the examples in 03_Sloshing.
</p>
...
<p align="center">
<strong>Figure 7-XX.</strong> Experimental and numerical pressures measured at the sensor with DBC and mDBC [English et al., 2019].
</p>
...
<p align="center">
<strong>Figure 7-XX.</strong> Snapshot of simulation of the examples in 04_Dambreak.
</p>
...
<p align="center">
<strong>Figure 7-XX.</strong> Snapshot of simulation of the examples in 05_FlowCylinder.
</p>
...
<p align="center">
<strong>Figure 7-XX.</strong> Snapshot of simulation of the examples in 06_WaveTank.
</p>
...
<p align="center">
<strong>Figure 7-XX.</strong> Snapshot of simulation of the examples in 07_WavesCylinder.
</p>
...
Different instants of the simulation plotting _CaseDambreak_Sediment_Bound.vtk_, the files _PartFluid_xxxx.vtk_ and _PartSediment_xxxx.vtk_ can be seen in Figure 7-58. 
...
<p align="center">
<strong>Figure 7-58.</strong> Different instants of the CaseDambreak_Sediment simulation.
</p>
...
<p align="center">
<strong>Figure 7-59.</strong> Testcases of the multiphase code Liquid-Gas.
</p>
