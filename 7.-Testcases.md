...
- [7.5 wavecoupling examples](#74-wavecoupling-examples)
...
<p align="center">
<img src="https://imgur.com/XXXXXXXXXXXX.png" />
</p>
...
3-D regular waves (H=0.1m, T=1.2s, d=0.5m) passing a cylinder of diameter D=0.2m and 0.7m high located in the middle of a wave flume. The time series of the drag forces are compared with the theoretical values using the Morison equation.
