...
### 5.3.1 PreProcessing using GenCase
...
### 5.3.2 Preprocessing using Graphical User Interface (GUI)
...
VisualSPHysics: https://github.com/EPhysLab-UVigo/VisualSPHysics
