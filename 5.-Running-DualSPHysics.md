...
- [5.1 Directory Structure](#51-directory-structure)
  ...
  * [5.1.2 Examples](#522-examples)
  * [5.1.3 Format files](#523-format-files)
  * [XML File](#xml-file)
  * [BINARY File](#binary-file)
  * [VTK File](#vtk-file)
- [5.2 Running the DualSPHysics Code](#52-running-the-dualsphysics-code)
  * [5.2.1 Overview of DualSPHysics Workflow](#521-overview-of-dualsphysics-workflow)
  * [5.2.2 Running an example case on Windows](#522-running-an-example-case-on-windows)
  * [5.2.3 Running an example case on Linux](#523-running-an-example-case-on-linux)
- [5.3 Preprocessing](#53-preprocessing)
  * [TO RUN GENCASE:](#to-run-gencase-)
  * [example: `GenCase Case_Def Case [options]`](#example---gencase-case-def-case--options--)
- [5.4 Processing](#54-processing)
  * [TO RUN DUALSPHYSICS:](#to-run-dualsphysics-)
  * [example: `DualSPHysics Case [options]`](#example---dualsphysics-case--options--)
  * [FILE Run.out:](#file-runout-)
- [5.5 Postprocessing](#55-postprocessing)
  * [5.5.1 Visualization of particle output data (PartVTK)](#551-visualization-of-particle-output-data--partvtk-)
  * [5.5.2 Visualization of boundaries (BoundaryVTK)](#552-visualization-of-boundaries--boundaryvtk-)
  * [5.5.3 Analysis of numerical measurements (MeasureTool)](#553-analysis-of-numerical-measurements--measuretool-)
  * [5.5.4 Force computation (ComputeForces)](#554-force-computation--computeforces-)
  * [5.5.5 Analysis of floating data (FloatingInfo)](#555-analysis-of-floating-data--floatinginfo-)
  * [5.5.6 Surface representation (IsoSurface)](#556-surface-representation--isosurface-)
  * [5.5.7 Flow rate computation (FlowTool)](#557-flow-rate-computation--flowtool-)
  * [5.5.8 Visualisation using Blender](#558-visualisation-using-blender)
- [5.6 Graphical User Interface](#56-graphical-user-interface)
...
* The folder **guides** contains the following PDF files:
  ...
  * XML_v5.0_GUIDE.pdf: Helps to create a new case using the input XML file and all XML parameters are explained and related to SPH equations.
