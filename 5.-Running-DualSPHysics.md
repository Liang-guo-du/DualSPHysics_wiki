...
- [5.2 Directory Structure](#52-directory-structure)
  ...
  * [5.2.4 Input/Output XML File](#524-input-output-xml-file)
  * [5.2.5 Output BINARY File](#525-output-binary-file)
  * [5.2.5 Output VTK File](#525-output-vtk-file)
...
- [5.4 Preprocessing](#54-preprocessing)
  * [5.4.1 TO RUN GENCASE:](#541-to-run-gencase-)
- [5.5 Processing](#55-processing)
  * [5.5.1 TO RUN DUALSPHYSICS:](#551-to-run-dualsphysics-)
...
<p align="center">
<img width="400px" src="https://i.imgur.com/E1dsRrP.png"/>   
</p>
 ...
 * The examples in **mphase_liquidgas** will use the twophase code for liquid and gas.
 * The examples in **mphase_nnewtonian** will use the the code that includes rheology models, non-Newtonian formulations and multiphase flows.
...
<p align="center">
<img width="400px" src="https://i.imgur.com/r6BKxz4.png"/>     
</p>
...
<p align="center">
<img width="600px" src="https://imgur.com/1RB6Upy.png"/>  
</p>
