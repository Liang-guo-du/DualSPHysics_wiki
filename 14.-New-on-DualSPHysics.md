...
* Relaxation zone techniques (currents can now be simulated)
* Examples can be found in the subfolder **examples/wavecoupling**

• **Open boundary conditions: inlet & outlet**
* Unsteady velocity and pressure profiles and/or pressure and velocity gradients can now be assigned.
* The water depth can be either predefined or extrapolated from the fluid.
* Backflow allows flow reversion.
