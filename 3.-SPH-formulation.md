...
where the subscript denotes an individual particle, **v**<sub>_b_</sub> is the volume of a neighbouring particle (_b_). If <img src="https://i.imgur.com/j1FPDqE.png" height="24">, with _m_ and _ρ_ being the mass and the density of particle _b_ respectively then Eq. (2) becomes
...
where αD is equal to 10/7πh<sup>2</sup> in 2-D and 1/πh<sup>3</sup> in 3-D.
