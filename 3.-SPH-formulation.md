...
_v_<sub>_b_</sub>=_m_<sub>_b_</sub>/_ρ_<sub>_b_</sub>

<img src="https://i.imgur.com/j1FPDqE.png" height="24">, with _m_ and _ρ_ being the mass and the density of particle _b_ respectively then Eq. (2) becomes
...
In the text that follows, only kernels with an influence domain of 2_h_ (_q_≤2) are
considered
