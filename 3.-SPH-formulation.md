...
Beta is an index going from 1 to d, the total number of dimensions. Equations (94, 95) form a system of d + 1 equations in d + 1 unknowns, i.e. f<sub>k</sub> and f<sub>k,B</sub>. Using particle notation, the approximations of f<sub>k</sub> and f<sub>k,B</sub> translate into matrix equations that give the values of f<sub>k</sub> and f<sub>k,B</sub>, calculated as:
