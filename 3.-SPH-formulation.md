...
<p align="center">
<img src="https://i.imgur.com/XXXX.png"/> (119)
</p>

where _τ_ is the shear stress tensor, derivative of _γ_ ̇is the symmetric shear rate tensor given by,

<p align="center">
<img src="https://i.imgur.com/XXXX.png"/> (120)
</p>

with Δ**v** and **v**<sup>_T_</sup>  is the velocity gradient and transpose respectively and η_app is the apparent viscosity,

<p align="center">
<img src="https://i.imgur.com/XXXX.png"/> (121)
</p>

In the above τ_y is the yield stress of the fluid, μ is the viscosity (or consistency index usually denoted by K), n is the power law index (commonly referred to as the Herschel-Bulkley parameter) and m the exponential shear rate growth parameter (or Papanastasiou parameter) and (|γ| ) ̇ is the magnitude of the symmetric strain rate tensor defined as,

<p align="center">
<img src="https://i.imgur.com/XXXX.png"/> (122)
</p>
...
<p align="center">
<strong>Figure 3-13.</strong> Initial rapid growth of stress by varying m and effect of the power law index _n_ for the HBP model.
</p>

The implementation of the HBP model in DualSPHysics is outlined next. The momentum equation of eq. 11 is written as

<p align="center">
<img src="https://i.imgur.com/XXXX.png"/> (123)
</p>
...
<p align="center">
<img src="https://i.imgur.com/XXXX.png"/> (124)
</p>

where   is the apparent kinematic viscosity. The second formulation takes advantage of the conservative gradient operator in SPH form such as the viscous forces are discretised by,

<p align="center">
<img src="https://i.imgur.com/XXXX.png"/> (125)
</p>
...
<p align="center">
<img src="https://i.imgur.com/XXXX.png"/> (126)
</p>
...
<p align="center">
<img src="https://i.imgur.com/XXXX.png"/> (127)
</p>

whereas the later takes the following form,

<p align="center">
<img src="https://i.imgur.com/XXXX.png"/> (128)
</p>
