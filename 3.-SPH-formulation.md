...
## 3.5 Density difussion term
Within DualSPHysics it is also possible to apply a density difussion term, that
...
This represents the density difussion formulation by [Molteni and Colagrossi, 2009],
...
### 3.8.5 Modified Dynamic Boundary Condition RENATO?
