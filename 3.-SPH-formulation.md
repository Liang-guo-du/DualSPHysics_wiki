...
where <img src="http://latex.codecogs.com/gif.latex?\vec{\tau&space;}" title="\vec{\tau }" /> is the shear stress tensor, derivative of <img src="http://latex.codecogs.com/gif.latex?\dot{\gamma&space;}" title="\dot{\gamma }" /> ̇is the symmetric shear rate tensor given by,

<p align="center">
<img src="https://i.imgur.com/IC0WFPG.png" width="160px"/> (120)  
</p>

with <img src="http://latex.codecogs.com/gif.latex?\nabla(u)" title="\nabla(u)" /> and <img src="http://latex.codecogs.com/gif.latex?\nabla{u^{T}}" title="\nabla{u^{T}}" /> the velocity and transpose respectively and _η_<sub>_app_</sub> is the apparent viscosity,
