...
Tsunamis are giant waves generated in the deep ocean due to a rapid displacement of a large volume of water that occurs as consequence of earthquakes and submarine landslides. Considering the technical limitations to generate a tsunami at laboratory scale and the complex hydrodynamics that characterises the generation process of a tsunami event, researchers employ solitary waves to mimic tsunamis since. There are several generation systems of solitary waves. In the particular case of the DualSPHysics model the piston-type wave generation technique for single and multiple solitary waves has been implemented [Dominguez et al., 2019].

3.9.5.1. Single solitary wave

The generation of solitary waves by means of a piston-type wavemaker has been studied during the last decades by implementing the methodology described in Goring (1978) which is based on the Boussinesq solitary wave solution. The aim of this theory is to calculate the time series of the displacement of the wavemaker in order to achieve a well-established solitary wave profile with specific characteristics. Goring’s method is based on one fundamental hypothesis: the horizontal velocity of the water particles under the wave crest, u, is equal to the velocity of the wavemaker, which moves only horizontally. For very long waves this velocity is basically constant with depth. In general Goring’s hypothesis corresponds to the assumption that the vertical integrated fluid velocity, u, is equal to the local velocity. Therefore, u refers to a depth-integrated velocity.
Equation (45) defines the aforementioned assumption, where xs refers to the piston displacement.
<p align="center">
<img src="https://i.imgur.com/XXXXXX.png"/> (45)
</p>
...
<p align="center">
<img src="https://i.imgur.com/XXXXXX.png"/> (48)
</p>
Equation (48) is an implicit equation that needs to be solved by numerical methods.
Since a solitary wave is not a perfect realisation of tsunami waves, three different theories for solitary wave generation have been implemented in DualSPHysics. For all cases, solitary waves are generated by horizontal displacements of a piston-type wavemaker (modelled as a moving boundary in DualSPHysics).
The three different approaches result in different wave propagation properties (i.e. different loss of amplitude and differences in generated trailing waves). Two of the three methods are based on the procedures described in Katell (2002). One solution is derived from the Rayleigh solitary wave solution and the other one uses a wavemaker law-of-motion derived from the KdV solution (i.e. first-order shallow water solution). The third wave generation technique implemented in DualSPHysics solves equation (48) iteratively using the Newton-Raphson method to obtain the time series of the piston displacement.
Katell (2002) discussed on the differences in the generated solitary waves for different wave generation theories. With respect to the stability of the main pulse, the author concluded that the loss of amplitude as the solitary wave propagates is smaller using the Rayleigh solution. Furthermore, he pointed out that “all solitary waves generated using a paddle law of motion derived from KdV or second-order shallow water theory exhibit a trough (dispersive wave) after the main pulse …”. To get rid of possible dispersive tails in the generated solitary waves, the DualSPHysics user can increment the generation time using a correction coefficient defined in the input file for solitary wave generation. As noticed by Katell (2002), the amplitude of the trailing waves is reduced by increasing the duration of motion 10%. Nevertheless, the main pulse shows a more rapid decrease in amplitude as it propagates.
The aforementioned differences among solitary wave generation theories justify their implementation in DualSPHysics in order to enhance the model versatility. The following subsections described the three different theories.
...
<p align="center">
<img src="https://i.imgur.com/XXXXXX.png"/> (49)
</p>
The quantity 2*sqrt(H(H+h)/3) corresponds to half wavemaker stroke (SR) and takes into account that in DualSPHysics the origin of the wavemaker movement is set as x=0. The quantity defined as c is the wave celerity; Tf is the generation time used to form the solitary wave, xs is the wavemaker displacement and k is the outskirt coefficient. All these parameters are defined as follows:
<p align="center">
<img src="https://i.imgur.com/XXXXXX.png"/> (50)
</p>
<p align="center">
<img src="https://i.imgur.com/XXXXXX.png"/> (51)
</p>
<p align="center">
<img src="https://i.imgur.com/XXXXXX.png"/> (52)
</p>
<p align="center">
<img src="https://i.imgur.com/XXXXXX.png"/> (53)
</p>
In Eqs. (50-53) H and h refer to the wave height and to the water depth, respectively.
...
<p align="center">
<img src="https://i.imgur.com/XXXXXX.png"/> (54)
</p>
where the outskirt coefficient is now expressed as:
<p align="center">
<img src="https://i.imgur.com/XXXXXX.png"/> (55)
</p>
and cKdV can be expressed as follows:
<p align="center">
<img src="https://i.imgur.com/XXXXXX.png"/> (56)
</p>
...
A single tectonic event can trigger the generation and propagation of a wave train of several tsunamis or tsunami-like solitary waves. Even if a single tsunami wave is generated, it can break up into a series of several solitary waves, resulting in a different interaction of solitary waves with coastal structures (Goring, 1978). In order to generate N multiple solitary waves (N=2, 3,…,10) a simple algorithm is introduced in DualSPHysics. The law of motion of the wavemaker is calculated for each solitary wave that forms the wave train to be simulated. Any of the three theories indicated in the previous sections can be used. Then, the time lag between the i+1-th and the i-th solitary wave has to be specified as a fraction or multiple of the generation time used for the i-th solitary wave. Hence, the time lag-between the generation of the two solitary waves can be defined as λTf, where Tf is the generation time used to generated the first solitary wave as expressed in equation (51). The coefficient λ is a positive real number that multiplies Tf. If λ<1, the generation of the second solitary wave starts when the displacement of the piston has not reached yet the maximum stroke that is needed to generate the first solitary wave.
...
<p align="center">
<img src=https://i.imgur.com/wOYwuKU.png>
</p>
...
### 3.14.3 Non-penetration constraints
...
### 3.14.4 Frictional constraints - The Coulomb friction model
...
### 3.14.5 Complete multi-body model
...
## 3.15 Coupling with wave propagation models
...
### 3.15.1 Multi-layered piston wavemaker
...
<p align="center">
<img src="https://imgur.com/A4F3EF2.png"/> (90)
</p>

<p align="center">
<img src="https://imgur.com/nyeVkut.png"/> (91)
</p>
...
<p align="right">
<img src="https://imgur.com/wivNkL4.png"/> (92)
</p>
...
<p align="center">
<img src="https://imgur.com/tjpMznC.png"/> (93)
</p>
...
<p align="center">
<img src="https://i.imgur.com/f8qfUWu.png" width="600" /> (94)
</p>
<p align="center">
<img src="https://i.imgur.com/CLVzb6K.png" width="600" /> (95)
</p>

Beta is an index going from 1 to <i>d</i>, the total number of dimensions. Equations (94, 95) form a system of <i>d</i> + 1 equations in <i>d</i> + 1 unknowns, i.e. <i>f</i><sub>k</sub> and f<sub>k,B</sub>. Using particle notation, the approximations of <i>f</i><sub>k</sub> and <i>f</i><sub>k,B</sub> translate into matrix equations that give the values of f<sub>k</sub> and f<sub>k,B</sub>, calculated as:

<p align="center">
<img src="https://i.imgur.com/TLj0ydO.png" width="600" /> (96)
</p>
<p align="center">
<img src="https://i.imgur.com/4h1AMcd.png" width="600" /> (97)
</p>
